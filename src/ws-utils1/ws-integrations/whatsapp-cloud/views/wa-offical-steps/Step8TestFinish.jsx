...
export default function Step8TestFinish({ wizard, setWizard }) {
  ...
  const [sender, setSender] = React.useState(wizard.numberId || numbers[0]?.value);
  ...
  const templates = [
    { value: 't1', label: 'Welcome Message (Marketing, Approved, EN)' },
    { value: 't2', label: 'OTP Verification (Authentication, Approved, EN)' },
  ];
